function [u res it] = precondCG(u0,rhs,N,tol,maxit,nu1,nu2,X,Y,k)
    h = 1/N;
    b  = rhs;
    x0 = u0;
    x = x0;
    ...
    id = 2:N;
    %PCG starts here
    Ax0 = 1/h^2.*matvec(x0,N,h,k);
    r0(id,id) = b(id,id) - Ax0(id,id);
    z0 = mgv(zeros(N+1,N+1),r0,N,nu1,nu2,1,4,k); 
    z = z0;
    r = r0;
    p0 = z0;
    p = p0;
